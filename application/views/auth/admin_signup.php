		...
		<div class="col-md-6 col-sm-6 col-lg-6 col-xl-6">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<?php echo form_open('AdminRegister/register_admin') ?>
					<div class="modal-body mx-3">
						<div class="md-form mb-5">
							<i class="fa fa-user prefix grey-text"></i>
							<input type="hidden" name="role" value="2">
							<input type="text" id="orangeForm-name" name="full_name"
								value="<?= set_value('full_name')?>" class="form-control validate" required>
						...
						<div class="md-form mb-4">
							<i class="fa fa-lock prefix grey-text"></i>
							<input type="text" name="resturant_name" class="form-control validate" required
								value="<?= set_value('resturant_name')?>" >
							<label data-error="wrong" data-success="right" for="confirm_password">Resturant Name
							</label>
						</div>
